...
public class DlgUserOrder extends JDialog implements ActionListener {
	...
	public void reloadOrderTable() {
		try {
			allOrder = PetUtil.orderManager.selectOrder(FrmManagerMain.dlgManagerUser.allUser.get(FrmManagerMain.dlgManagerUser.dataUserType.getSelectedRow()).getUser_id());
