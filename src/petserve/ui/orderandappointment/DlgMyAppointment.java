...
public class DlgMyAppointment extends JDialog implements ActionListener {
	...
	public void reloadAppointmentTable() {
		try {
			allAppointment = PetUtil.appointmentManager.selectAppointment(BeanUser_information.currentLoginUser.getUser_id());
