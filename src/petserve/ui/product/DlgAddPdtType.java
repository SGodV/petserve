...
public class DlgAddPdtType extends JDialog implements ActionListener {
	...
	private JLabel labelPdtTypeName = new JLabel("商品类别名称：");
	private JLabel labelPdtTpeDsc = new JLabel("商品类别描述：");
	private JTextField edtPdtTypeName = new JTextField(20);
	private JTextField edtPdtTpeDsc = new JTextField(20);
	
	public DlgAddPdtType() {
		// TODO Auto-generated constructor stub
		this.setTitle("新增商品类别");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnCancel)
			...
			try {
				PetUtil.productTypeManager.addPdtType(edtPdtTypeName.getText(), edtPdtTpeDsc.getText());
				this.setVisible(false);
