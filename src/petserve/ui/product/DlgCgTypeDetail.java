...
public class DlgCgTypeDetail extends JDialog implements ActionListener {
	...
	private JLabel label1 = new JLabel("新描述：");
	private JTextField edt1 = new JTextField(20);

	public DlgCgTypeDetail() {
		// TODO Auto-generated constructor stub
		this.setTitle("修改商品类别描述");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				PetUtil.productTypeManager.changePdtTypeDsc(DlgLogin.frmManagerMain.allPdtType.get(i).getType_code(), 
						this.edt1.getText());
