...
public class DlgCgPdtCode extends JDialog implements ActionListener {
	...
	private JLabel label1 = new JLabel("新条码：");
	private JTextField edt1 = new JTextField(20);

	public DlgCgPdtCode() {
		// TODO Auto-generated constructor stub
		this.setTitle("修改商品条码");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				PetUtil.productInformationManager.changePdtCode(DlgLogin.frmManagerMain.allPdtIfm.get(i).getProduct_id(), 
						this.edt1.getText());
