...
public class DlgCgTypeName extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				PetUtil.productTypeManager.changePdtTypeName(DlgLogin.frmManagerMain.allPdtType.get(i).getType_code(), 
						this.edt1.getText());
