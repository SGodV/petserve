...
public class DlgCgPrice extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				...
				PetUtil.productInformationManager.changePrice(DlgLogin.frmManagerMain.allPdtIfm.get(i).getProduct_id(), 
