...
public class DlgCgPdtName2 extends JDialog implements ActionListener {
	...
	public DlgCgPdtName2() {
		// TODO Auto-generated constructor stub
		this.setTitle("修改服务名称");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				PetUtil.productInformationManager.changePdtName(FrmManagerMain.dlgServeView.allServeIfm.get(i).getProduct_id(), 
						this.edt1.getText());
