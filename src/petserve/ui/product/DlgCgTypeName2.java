...
public class DlgCgTypeName2 extends JDialog implements ActionListener {
	...
	private JLabel label1 = new JLabel("新名称：");
	private JTextField edt1 = new JTextField(20);

	public DlgCgTypeName2() {
		// TODO Auto-generated constructor stub
		this.setTitle("修改商品类别名称");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				PetUtil.productTypeManager.changePdtTypeName(FrmManagerMain.dlgServeView.allServeType.get(i).getType_code(), 
						this.edt1.getText());
