...
public class DlgCgPdtName extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			...
			try {
				PetUtil.productInformationManager.changePdtName(DlgLogin.frmManagerMain.allPdtIfm.get(i).getProduct_id(), 
						this.edt1.getText());
