...
public class DlgChangePetAgeM extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			try {
				PetUtil.petManager.changePetAge(DlgManagerUser.dlgManagerPet.allPet.get(DlgManagerUser.dlgManagerPet.dataPetType.getSelectedRow()).getPet_id(), Short.parseShort(this.edt2.getText()));
