...
public class DlgChangePetNameM extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnConfirm) {
			try {
				PetUtil.petManager.changePetName(DlgManagerUser.dlgManagerPet.allPet.get(DlgManagerUser.dlgManagerPet.dataPetType.getSelectedRow()).getPet_id(), this.edt2.getText());
